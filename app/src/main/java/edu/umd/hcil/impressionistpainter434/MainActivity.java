...
public class MainActivity extends AppCompatActivity { //implements OnMenuItemClickListener {
    ...
    private static final int CAM_REQUEST = 1515;
...
//    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_camera:
                ...
                startActivityForResult(cIntent,CAM_REQUEST);
                return true;
            default:
    ...
    public void edit_brush() {
        AlertDialog.Builder builderSingle = new AlertDialog.Builder(MainActivity.this);
        builderSingle.setIcon(R.mipmap.ic_launcher);
        builderSingle.setTitle("Select A Brush:");

        final ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(
                MainActivity.this,
                android.R.layout.select_dialog_singlechoice);
        arrayAdapter.add("Circle Brush");
        arrayAdapter.add("Square Brush");
        arrayAdapter.add("Line Brush");
        arrayAdapter.add("Circle Splatter Brush");
        arrayAdapter.add("Line Splatter Brush");
        ...
        builderSingle.setAdapter(
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        builderInner.setTitle("Your new brush is");
                        builderInner.setPositiveButton(
                                ...
                                new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(
                                        ...
                                        switch (strName) {
                                            case "Circle Brush":
                                                Toast.makeText(MainActivity.this, "Circle Brush", Toast.LENGTH_SHORT).show();
                                                _impressionistView.setBrushType(BrushType.Circle);
                                                break;
                                            case "Square Brush":
                                                Toast.makeText(MainActivity.this, "Square Brush", Toast.LENGTH_SHORT).show();
                                                _impressionistView.setBrushType(BrushType.Square);
                                                break;
                                            case "Line Brush":
                                                Toast.makeText(MainActivity.this, "Line Brush", Toast.LENGTH_SHORT).show();
                                                _impressionistView.setBrushType(BrushType.Line);
                                                break;
                                            case "Circle Splatter Brush":
                                                Toast.makeText(MainActivity.this, "Circle Splatter Brush", Toast.LENGTH_SHORT).show();
                                                _impressionistView.setBrushType(BrushType.CircleSplatter);
                                                break;
                                            case "Line Splatter Brush":
                                                Toast.makeText(MainActivity.this, "Line Splatter Brush", Toast.LENGTH_SHORT).show();
